...
if __name__ == "__main__":
    ...
    # print(transcript.text) # works
    channel_videos: List[ChannelVideo] = scraper.scrape_channel("UCn8ujwUInbJkBhffxqAPBVQ", hours=24) #scraper.scrape_channel("UCn8ujwUInbJkBhffxqAPBVQ", hours=200)